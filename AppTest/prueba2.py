...
Treeview.column("Valuex", width=200, anchor='center')

Treeview.heading("Items", text="Itemsx")
Treeview.heading("Values", text="Values")
Treeview.heading("Valuex", text="Valuex")

Treeview.pack(side=LEFT, fill=BOTH)

name = ['Item1', 'Item2', 'Item3']
name1 = ['clu1', 'clu2', 'clu3']
ipcode = ['10', '25', '163']
for i in range(min(len(name), len(ipcode))):
    Treeview.insert('', i, values=(name[i], ipcode[i], name1[i]))
