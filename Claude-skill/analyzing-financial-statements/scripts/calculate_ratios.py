        ...
        interpretations = {
            "current_ratio": lambda v: (
                ...
                if v > 2
                    ...
                    "Adequate liquidity"
                    if v > 1.5
                    else "Potential liquidity concerns" if v > 1 else "Liquidity issues"
                )
            ),
            "debt_to_equity": lambda v: (
                ...
                if v < 0.5
                    ...
                    "Moderate leverage"
                    if v < 1
                    else "High leverage" if v < 2 else "Very high leverage"
                )
            ),
            "roe": lambda v: (
                "Excellent returns"
                if v > 0.20
                    ...
                    if v > 0.15
                        ...
                        "Average returns"
                        if v > 0.10
                        else "Below average returns" if v > 0 else "Negative returns"
                    )
                )
            ),
            "pe_ratio": lambda v: (
                ...
                if 0 < v < 15
                    ...
                    if 15 <= v < 25
                        ...
                        if 25 <= v < 40
                            ...
                            "High valuation"
                            if v >= 40
                            else "N/A (negative earnings)" if v <= 0 else "N/A"
                        )
                    )
                )
            ),
