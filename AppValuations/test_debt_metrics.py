#!/usr/bin/env python
"""
Test para verificar extracción de métricas de deuda en PBR
"""
import sys
...
print("="*80)
print("🧪 TEST DE MÉTRICAS DE DEUDA - VALE")
print("="*80)

# Get VALE filings
ticker_dir = "EDGAR/VALE_EDGAR_Files"
file_list = get_zip_files(ticker_dir, display_logs=False)

print(f"\n✅ Found {len(file_list)} filings for VALE")

# Run valuation with current market price
result = run_valuation(
    file_list=file_list,
    ticker="VALE",
    price=13.29,  # Current market price approx
...
if result:
    ...
    if total_debt and total_debt > 0:
        ...
        print("\n❌ FALLO: No se extrajeron métricas de deuda")
