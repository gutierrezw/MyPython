...
class IBClient:  # ------------------------------------------------------------------------------------------------------
    ...
    def _check_authentication_non_input(self) -> bool:
        ...
        # If it is being True we are good.
    ...
    def get_live_orders(self):
        ...
        # define request components
        # endpoint = r'iserver/account/orders?filters=filled&force=true'
    ...
    def fundamentals_financials(self, conid, financial_statement, period):
        pass
