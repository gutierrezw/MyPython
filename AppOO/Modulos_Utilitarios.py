...
AGENTES_SCHEDULE = {
    ...
    "Agente_InstitucionalScore": {
        "intervalo": 86400,
        "desc": "Ownership institucional (diario)",
        "active": True,
        "nivel": 2,
    },
    "Agente_ConsensoCache": {
        "intervalo": 300,
        "desc": "Materializa consenso_tag en market (5 min)",
        "active": True,
        "nivel": 2,
    },
    "Agente_EdgarFunds": {
        "intervalo": 2592000,
        "desc": "Fondos EDGAR company.idx (mensual)",
        "active": True,
        "nivel": 1,
    },
    "Agente_FundFilings": {"intervalo": 604800, "desc": "Descarga XMLs 13F-HR (semanal)", "active": True, "nivel": 2},
    "Agente_13FHoldings": {
        "intervalo": 86400,
        "desc": "Parsea XMLs → fund_holdings (diario)",
        "active": True,
        "nivel": 2,
    },
    "Agente_13FScores": {"intervalo": 86400, "desc": "Recalcula inst_score (diario)", "active": True, "nivel": 2},
    "Agente_AuditPortfolio": {
        "intervalo": 2592000,
        "desc": "Auditoría cartera delistados (mensual)",
        "active": True,
        "nivel": 1,
    },
    ...
    "Agente_LtvControl": {"intervalo": 300, "desc": "LTV colateral Binance (5 min)", "active": True, "nivel": 1},
    "Agente_StockBeta": {"intervalo": 3600, "desc": "Beta portfolio Stock (1 hora)", "active": True, "nivel": 1},
